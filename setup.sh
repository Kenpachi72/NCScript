...
echo "AJOUT PERSONNEL E.Y."
echo "ENTRER IP HOTE BASE DE DONNEE" 
echo ""
read -p "ADDRESSE IP OU LOCALHOST , par defaut ${mysqlhost}: " MYSQLHOST

[ -z "$MYSQLHOST" ] ||  mysqlhost=$MYSQLHOST
clear
...
echo "hôte base de données: ${mysqlhost} "
